//Create student class with name(String type) and regno (int type) attributes. use any collection
//to Store 5 student information. sort students using name(only unique student objects should
//be printed (Ex s1(aa,11) s2(aa,12) s3(aa,11) s4(bb,12) then s1(aa,11) s2(aa,12) s4(bb,12) should
//be printed.
package UniqueStudent;
